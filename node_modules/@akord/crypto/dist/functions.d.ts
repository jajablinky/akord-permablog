 ...
 * @returns {Promise.<CryptoKey>} crypto key object
 */
declare function importKeyFromSeed(seed: Uint8Array): Promise<any>;
/**
 ...
 */
declare function encrypt(plaintext: Uint8Array, key: CryptoKey, encode?: boolean): Promise<string | {
    ciphertext: any;
    iv: string;
}>;
/**
 ...
 */
declare function decrypt(encryptedPayload: string, key: CryptoKey, decode?: boolean): Promise<any>;
/**
 ...
 */
declare function deriveKey(password: string, salt: Uint8Array): Promise<any>;
/**
 ...
 */
declare function generateKeyPair(): Promise<import("libsodium-wrappers").KeyPair>;
 ...
 * @returns {Promise.<Uint8Array>} Promise of raw plaintext byte array
 */
declare function encryptHybridRaw(plaintext: Uint8Array, publicKey: Uint8Array, encode?: boolean, accessKey?: CryptoKey): Promise<string | {
...
declare function encryptHybridString(plaintext: string, publicKey: Uint8Array): Promise<string | {
    encryptedData: string | {
        ciphertext: any;
        iv: string;
    };
 ...
 */
declare function decryptHybridRaw(encryptedPayload: string, privateKey: Uint8Array, decode?: boolean): Promise<any>;
...
declare const importRSAPublicKey: (publicKey: any) => Promise<any>;
declare const importRSACryptoKey: (jwk: any) => Promise<any>;
