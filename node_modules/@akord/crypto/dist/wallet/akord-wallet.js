...
class AkordWallet {
    ...
    encrypt(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, functions_1.encryptRawWithPublicKey)(yield this.publicKeyRaw(), input);
        });
    }
    decrypt(input) {
    ...
    sign(string) {
        return __awaiter(this, void 0, void 0, function* () {
            const signingKey = yield this.signingPrivateKeyRaw();
            return (0, functions_1.signString)(string, signingKey);
        });
    }
    getAddress() {
        return __awaiter(this, void 0, void 0, function* () {
            const signingPublicKey = yield this.signingPublicKeyRaw();
            return (0, functions_1.deriveAddress)(signingPublicKey, "akord");
        });
    }
    /**
     * Create the wallet
   ...
   */
     ...
     */
    publicKey() {
        return Promise.resolve((0, encoding_1.arrayToBase64)(this.keyPair.publicKey));
    }
    /**
     * Signing private key
     * @returns {Uint8Array}
    ...
    signingPrivateKeyRaw() {
        return Promise.resolve(this.signingKeyPair.privateKey);
    }
    /**
     * Signing public key
     * @returns {Uint8Array}
     */
    signingPublicKeyRaw() {
        return Promise.resolve(this.signingKeyPair.publicKey);
    }
    /**
     ...
     */
    signingPrivateKey() {
        return Promise.resolve((0, encoding_1.arrayToBase64)(this.signingKeyPair.privateKey));
    }
    /**
     ...
     */
    signingPublicKey() {
        return Promise.resolve((0, encoding_1.arrayToBase64)(this.signingKeyPair.publicKey));
    }
}
