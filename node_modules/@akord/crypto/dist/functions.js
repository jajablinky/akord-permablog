...
function decodePayload(payload) {
    ...
    parsedPayload.ciphertext = (0, encoding_1.base64ToArray)(parsedPayload.ciphertext);
    parsedPayload.iv = (0, encoding_1.base64ToArray)(parsedPayload.iv);
...
function decryptHybridString(encryptedPayload, privateKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const decryptedDataArray = yield decryptHybridRaw(encryptedPayload, privateKey);
